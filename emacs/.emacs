...
;; and or etc.
(add-to-list 'pretty-symbol-patterns '(8743 kdm-custom "\\<and\\>" (text-mode prog-mode ess-mode)))  
(add-to-list 'pretty-symbol-patterns '(8743 kdm-custom "\\<und\\>" (text-mode prog-mode ess-mode)))  
(add-to-list 'pretty-symbol-patterns '(8744 kdm-custom "\\<or\\>" (text-mode prog-mode ess-mode)))  
(add-to-list 'pretty-symbol-patterns '(8744 kdm-custom "\\<oder\\>" (text-mode prog-mode ess-mode)))  
(add-to-list 'pretty-symbol-patterns '(172 kdm-custom "\\<nicht\\>" (text-mode prog-mode ess-mode)))
(add-to-list 'pretty-symbol-patterns '(172 kdm-custom "\\<not\\>" (text-mode prog-mode ess-mode)))

;; functions
(add-to-list 'pretty-symbol-patterns '(402 kdm-custom "\\<function\\>" (text-mode prog-mode ess-mode)))
(add-to-list 'pretty-symbol-patterns '(402 kdm-custom "\\<defun\\>" (text-mode prog-mode ess-mode)))
(add-to-list 'pretty-symbol-patterns '(402 kdm-custom "\\<def\\>" (text-mode prog-mode ess-mode)))
(add-to-list 'pretty-symbol-patterns '(?✠ kdm-custom "\\<return\\>" (text-mode prog-mode ess-mode)))
(add-to-list 'pretty-symbol-patterns '(?Ø kdm-custom "\\<NULL\\>\\|\\<nil\\>" (text-mode prog-mode ess-mode)))
;; superscripts                                      
...
;; python specific
(add-to-list 'pretty-symbol-patterns '(?⓪ kdm-custom "None" (python-mode inferior-python-mode text-mode prog-mode ess-mode)))         

...
** Hasklig
#+BEGIN_SRC emacs-lisp :tangle yes
(defconst hasklig-font-lock-keywords-alist
...
(defun add-hasklig-code-symbol-keywords ()
  (font-lock-add-keywords nil hasklig-font-lock-keywords-alist))

(add-hook 'haskell-mode-hook #'add-hasklig-code-symbol-keywords)
#+END_SRC
** inits
#+BEGIN_SRC emacs-lisp :tangle yes

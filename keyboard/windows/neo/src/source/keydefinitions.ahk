...
EDS("002",0,"ß","°","¹","S__PgUp"      ,"₁","¬") ; 1
EDS("003",0,"2","§","²","º"      ,"₂","∨") ; 2
EDS("004",0,"u","U","_","U000008"      ,"₃","∧") ; 3
EDS("005",0,"ü","Ü","[","S____Up"       ,"♀","⊥") ; 4
EDS("006",0,".","«","]","S___Del"      ,"♂","∡") ; 5
EDS("007",0,"ä","Ä","^","S__PgDn"      ,"⚥","∥") ; 6
EDS("008",0,"v","V","!","¡"      ,"ϰ","→") ; 7
EDS("009",0,"g","G","<","S__N__7"       ,"⟨","∞") ; 8
EDS("00A",0,"c","C",">","S__N__8","⟩","∝") ; 9
EDS("00B",0,"l","L","=","S__N__9","₀","∅") ; 0
;EDSK("00C",0,"-","—","" ,"S__NSub","‑","­") ; -
EDS("00D",0,"j","J","&","S__NAdd","T_dasia","T__mcrn") ; grave
; Reihe 2
; EDSK("tab",1,"k","K","…","S__PgUp","ξ","Ξ") ; x
EDSK("010",1,"h","H","\","S__Home","ξ","Ξ") ; x
EDSK("011",1,"i","I","/","S__Left","" ,"√") ; v
EDSK("012",1,"e","E","{","S__Down","λ","Λ") ; l
EDSK("013",1,"a","A","}","S__Rght","χ","ℂ") ; c
EDSK("014",1,"o","O","*","S___End","ω","Ω") ; w
EDSK("015",1,"k","K","!","¡"      ,"κ","×") ; k   wird nicht benutzt
EDSK("016",1,"d","D","?","¿","ψ","Ψ") ; h
EDSK("017",1,"t","T","(","S__N__4","γ","Γ") ; g
EDSK("018",1,"r","R",")","S__N__5","φ","Φ") ; f
EDSK("019",1,"n","N","-","S__N__6","ϕ","ℚ") ; q
EDSK("01A",1,"s","S",":","S__NDot"      ,"ς","∘") ; ß
EDS("01B",0,"f","F","@",".","T_psili","T__brve") ; acute
; Reihe 3
EDSK("01E",1,"x","X","#","U00001B","" ,"⊂") ; u
EDSK("01F",1,"y","Y","$","U000009","ι","∫") ; i
EDSK("020",1,"ö","Ö","{","S__Down","α","∀") ; a
EDSK("021",1,",","E","}","U00000D","ε","∃") ; e
EDSK("022",1,"q","Q","*","S___End","ο","∈") ; o
EDSK("023",1,"s","S","?","¿"      ,"σ","Σ") ; s   wird nicht benutzt
EDSK("024",1,"b","B","","","ν","ℕ") ; n
EDSK("025",1,"p","P","%","S__N__1","ρ","ℝ") ; r
EDSK("026",1,"w","W","""","S__N__2","τ","∂") ; t
EDSK("027",1,"m","M","'","S__N__3","δ","Δ") ; d
EDSK("028",1,"z","Z",";","."      ,"υ","∇") ; y

; Reihe 4
EDSK("02C",1,"ü","Ü","#","U00001B","" ,"∪") ; ü
EDSK("02D",1,"ö","Ö","$","U000009","ϵ","∩") ; ö
EDSK("02E",1,"P__M4RD","P__M4RD","P__M4RD","P__M4RD","P__M4RD","P__M4RD") ; ä
; EDSK("02F",1,"p","P","~","U00000D","π","Π") ; p
;EDSK("030",1,"z","Z","``",""      ,"ζ","ℤ") ; z
;EDSK("031",1,"z","Z","``",""      ,"ζ","ℤ") ; z
;ED1("031","Ctrl") ; b
EDSK("032",1,"U000020","M","%","S__N__0","μ","⇔") ; m
EDSK("033",0,"P__M3RD","P__M3RD","P__M3RD","P__M3RD","P__M3RD","P__M3RD") ; ,
...
; other keys
ED("space",0,"{Ctrl}","P__M4RD","P__M4RD","P__M4RD","P__M4RD","P__M4RD")
ED("esc"  ,0,"U00001B","U00001B","P__Rlod","U00001B","U00001B","U00001B")
ED("tab"  ,0,"k","K","S__Comp","U000009","U000009","U000009")

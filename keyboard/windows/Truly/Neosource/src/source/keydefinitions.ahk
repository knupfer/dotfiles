...
; Reihe 2
EDSK("010",1,"k","K","…","S__PgUp","ξ","Ξ") ; x
EDSK("011",1,"u","U","_","U000008","" ,"√") ; v
EDSK("012",1,"ü","Ü","[","S____Up","λ","Λ") ; l
EDSK("013",1,".","C","]","S___Del","χ","ℂ") ; c
EDSK("014",1,"ä","Ä","^","S__PgDn","ω","Ω") ; w
EDSK("015",1,"v","V","!","¡"      ,"κ","×") ; k
EDSK("016",1,"g","G","<","S__N__7","ψ","Ψ") ; h
EDSK("017",1,"c","C",">","S__N__8","γ","Γ") ; g
EDSK("018",1,"l","L","=","S__N__9","φ","Φ") ; f
EDSK("019",1,"z","Z","&","S__NAdd","ϕ","ℚ") ; q
EDSK("01A",1,"f","F","@","."      ,"υ","∇") ; ß

EDSK("035",1,"ß","d","ſ","−"      ,"ς","∘") ; ß

EDS("01B",0,"T__acut","T__tlde","T__strk","T__dbac","T_psili","T__brve") ; acute
; Reihe 3
EDSK("01E",1,"h","H","\","S__Home","" ,"⊂") ; u
EDSK("01F",1,"i","I","/","S__Left","ι","∫") ; i
EDSK("020",1,"e","E","{","S__Down","α","∀") ; a
EDSK("021",1,"a","A","}","S__Rght","ε","∃") ; e
EDSK("022",1,"o","O","*","S___End","ο","∈") ; o
EDSK("023",1,"d","D","?","¿"      ,"σ","Σ") ; s
EDSK("024",1,"t","T","(","S__N__4","ν","ℕ") ; n
EDSK("025",1,"r","R",")","S__N__5","ρ","ℝ") ; r
EDSK("026",1,"n","n","-","S__N__6","τ","∂") ; t
EDSK("027",1,"s","S",":","S__NDot","δ","Δ") ; d
EDSK("028",1,"j","J",";",";"      ,"θ","Θ") ; y
; Reihe 4
EDSK("02C",1,"x","X","#","U00001B","" ,"∪") ; ü
EDSK("02D",1,"y","Y","$","U000009","ϵ","∩") ; ö
EDSK("02E",1,"ö","Ö","|","S___Ins","η","ℵ") ; ä
EDSK("02F",1,",","P","~","U00000D","π","Π") ; p
EDSK("030",1,"q","Q","``",""      ,"ζ","ℤ") ; z
EDSK("031",1,"b","B","+",":"      ,"β","⇐") ; b
EDSK("032",1,"p","P","%","S__N__1","μ","⇔") ; m
EDSK("033",0,"w","W","""","S__N__2","ϱ","⇒") ; ,
EDSK("034",0,"m","M","'","S__N__3","ϑ","↦") ; .
...
ED("backspace",0,"U00000D","U00000D","U00000D","S__NEnt","U00000D","U00000D")
...
ED1("left","P__M3LD") ; Mod3L (CapsLock)
ED1S("02B","P__M3RD") ; Mod3R (#')
; ED1S("056","P__M4LD") ; Mod4L (<>)
ED1("end","P__M4LD") ; Mod4L (<>)
